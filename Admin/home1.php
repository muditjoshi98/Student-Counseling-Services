        ...
        <div class="row content">
            <div class="col-sm-3 sidenav" id="side">
                <ul class="nav nav-pills nav-stacked">
                    <li class='active'><a href="#">Counseller</a></li>
            ...
            <div class="col-sm-2">
                <a href="cons_add.php?msg=<?php echo $_GET["msg"]; ?>">
                <h4>Add Counseller </h3>
                <img src="assets/img/add.ico" class="img-responsive" style="width:100%" alt="Add">
                </a>
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-2">
                <a href="cons_del.php?msg=<?php echo $_GET["msg"]; ?>">
                <h4>Remove Counseller</h4>
                <img src="assets/img/delete.png" class="img-responsive" style="width:100%" alt="Remove">
                </  a>
            </div>
